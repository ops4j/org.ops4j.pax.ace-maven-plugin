...
/**
 * Execute 'register' action for ACE Targets
 *
 * @author dpishchukhin
 */
@Mojo(name = "register", requiresProject = false, aggregator = true)
public class RegisterTargetActionMojo extends AbstractTargetActionAceMojo {
    @Override
    protected void executeAction(AceRestClient client) throws Exception {
        client.registerTargets(filter);
    }
